...
- [ ] Adicionar maneira de admin conseguir enviar uma mensagem para certos cargos, essa mensagem aparece nas notificações
- [ ] Quando tem novas notificações criar toast azul canto inferior direito
- [ ] Settings page
